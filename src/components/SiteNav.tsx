...
const NAV: NavGroup[] = [
  { label: 'Explore', items: [{ label: 'Ecosystem', to: '/ecosystem' }, { label: 'Journey', to: '/journey' }, { label: "Allocator's Guide", to: '/guide' }, { label: 'Glossary', to: '/glossary' }] },
  ...
  { label: 'Community', items: [{ label: 'Professor Octo', to: '/octo' }, { label: 'Quiz', to: '/quiz' }, { label: 'Programs', to: '/programs' }, { label: 'Participate', to: '/participate' }] },
  { label: 'FAQ', to: '/faq' },
];
